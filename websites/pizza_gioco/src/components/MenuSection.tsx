          ...
          <TabsContent value="dessert" className="mt-4 md:mt-8">
            <div className="md:bg-transparent md:p-0 md:rounded-none bg-transparent p-6 rounded-lg">
              ...
              <p className="text-red-700">
                Încheie masa cu o notă dulce! Clătitele noastre proaspete sunt preparate zilnic cu ingrediente naturale 
                și servite calde pentru o experiență culinară completă.
              </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <TabsContent value="special" className="mt-4 md:mt-8">
            <div className="md:bg-transparent md:p-0 md:rounded-none bg-transparent p-6 rounded-lg">
              ...
              <p className="text-green-700">
                Organizezi un eveniment special? Oferim servicii complete de catering pentru toate tipurile de evenimente - 
                petreceri private, evenimente corporative, nunți și multe altele. Pizza noastră proaspătă și pastele delicioase 
                vor face ca evenimentul tău să fie de neuitat!
              </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <TabsContent value="pomeni" className="mt-4 md:mt-8">
            <div className="md:bg-transparent md:p-0 md:rounded-none bg-transparent p-6 rounded-lg">
              ...
              <p className="text-blue-700">
                Oferim servicii complete pentru organizarea pomenirii celor dragi. Meniuri tradiționale și servicii 
                de catering adaptate pentru aceste momente speciale, cu respect și înțelegere pentru tradițiile familiei dumneavoastră.
              </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {pomeni.map((pomen) => (
