          ...
          >
            <div>
              ...
              <p className="text-gray-600 leading-relaxed text-[20px]">
                Fiecare buchet este realizat cu grijă și atenție la detalii, folosind cele mai frumoase și proaspete
                flori, selectate special pentru a completa perfect rochia și stilul ales.
              </p>
            </div>
