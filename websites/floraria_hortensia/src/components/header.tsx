        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            >
              ...
              <button onClick={() => scrollToSection('buchete')} className="text-gray-700 hover:text-pink-500 transition-colors duration-200">Buchete</button>
              <button onClick={() => scrollToSection('aranjamente')} className="text-gray-700 hover:text-pink-500 transition-colors duration-200">Aranjamente</button>
              <button onClick={() => scrollToSection('mireasa')} className="text-gray-700 hover:text-pink-500 transition-colors duration-200">Mireasă</button>
              <button onClick={() => scrollToSection('evenimente')} className="text-gray-700 hover:text-pink-500 transition-colors duration-200">Evenimente</button>
            ...
            >
              <a href="tel:+40123456789" className="flex items-center text-gray-700 hover:text-pink-500 transition-colors duration-200">
            ...
            <div className="grid lg:grid-cols-[1.618fr_1fr] gap-16 items-center h-full min-h-[80vh] py-8">
              ...
              >
                <div className="space-y-6">
                  ...
                  >
                    <h1 className="text-5xl md:text-7xl text-gray-800 leading-tight">
                      Florăria
                    </h1>
                    <h1 className="text-5xl md:text-7xl text-pink-500 leading-tight">
                      Hortensia
                    </h1>
                  </motion.div>
