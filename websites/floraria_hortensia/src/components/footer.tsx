    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed mb-4 font-light">
              ...
              Din februarie 2024, aducem bucurie în viețile oamenilor prin aranjamente florale unice.
            </p>
            <p className="text-sm text-gray-400 font-light">
              Florile sunt naturale, atent alese și tratate.
            </p>
          </motion.div>
        ...
        >
          ...
          <p className="text-sm mt-1 font-light">Făcut cu <Heart className="inline h-4 w-4 text-pink-400 mx-1" /> pentru iubitorii de flori</p>
        </motion.div>
      </div>
    </footer>
  );
