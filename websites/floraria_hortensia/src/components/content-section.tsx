...
export function ContentSection({
  ...
  return (
    <section id={id} className={`py-20 ${backgroundGradient} ${['funerare', 'mireasa', 'buchete'].includes(id) ? 'relative overflow-hidden' : ''}`}>
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${['funerare', 'mireasa', 'buchete'].includes(id) ? 'relative z-10' : ''}`}>
